...
{   //extend.from.controller
    //[Authorize(Roles = "admin,User")]//means.admin.or.User.if.seperated.by.2lines.will.be.must.be.both.of.them
    //[Authorize]
    //[Authorize(policy: "adminRolePolicy")]use.role.as.a.claim.with.type.role
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> CreateRole(CreateRoleViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.TryAddModelError("", identityError.Description);
                }
            }
            return View(model);
        }
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            else
            {
                ...
                var reslt = await roleManager.UpdateAsync(role);
                if (reslt.Succeeded)
                {
        ...
        public async Task<IActionResult> ManageUserRole(String userId)
        {
            ...
            //we.need.all.roles.for.this.user.so.we.make.a.list.of.this.viewModel
        ...
        public async Task<IActionResult> ManageUserRole(List<UserRolesViewModel> model, String userId)
        {
            ...
            //we.want.to.retrieve.all.roles.that's.user.belongs.to
        ...
        public async Task<IActionResult> ManageUserClaim(UserClaimsViewModel model)
        {
            ...
            //add.the.claim.value.true.or.false.updating.video98
            result = await userManager.AddClaimsAsync(user,
